...
export const registerSchematicTools = (addTool, pythonPath, scriptBasePath) => {
    ...
    addTool({
        ...
        handler: async ({ projectName, path, metadata }) => {
    ...
    addTool({
        ...
        handler: async ({ schematicPath, component }) => {
    ...
    addTool({
        ...
        handler: async ({ schematicPath, startPoint, endPoint }) => {
    ...
    addTool({
        ...
        handler: async ({ schematicPath, outputPath }) => {
