...
export function registerComponentPrompts(server) {
    ...
    server.registerPrompt({
        ...
        description: "Helps select appropriate components for specific circuit requirements",
        template: `You're helping to select components for a circuit design. Given the following requirements:
...
For each component type, recommend specific values and provide a brief explanation of your recommendation. If appropriate, suggest alternatives with different trade-offs.`,
    ...
    server.registerPrompt({
        ...
        description: "Provides guidance on optimal component placement for PCB layout",
        template: `You're helping with component placement for a PCB layout. Here are the components to place:
...
Group components functionally and suggest a logical arrangement. If possible, provide a rough sketch or description of component zones.`,
    ...
    server.registerPrompt({
        ...
        description: "Analyzes options for replacing components with alternatives",
        template: `You're helping to find a replacement for a component that is unavailable or needs to be updated. Here's the original component information:
...
Suggest suitable replacement options and explain the advantages and disadvantages of each. Include any circuit modifications that might be necessary.`,
    ...
    server.registerPrompt({
        ...
        description: "Helps diagnose component-related issues in a PCB design",
        template: `You're helping to troubleshoot an issue with a component or circuit section in a PCB design. Here's the issue description:
...
Based on the available information, suggest likely causes of the issue and recommend specific steps to diagnose and resolve the problem.`,
    ...
    server.registerPrompt({
        ...
        description: "Assists with calculating appropriate component values for specific circuit requirements",
        template: `You're helping to calculate appropriate component values for a specific circuit function. Here's the circuit description and requirements:
...
//# sourceMappingURL=src-prompts-component.js.map